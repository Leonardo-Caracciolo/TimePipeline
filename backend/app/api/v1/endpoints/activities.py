...
def list_activities(
    ...
    filters = ActivityFilters(
        ...
        is_deadline=is_deadline, page=page, page_size=page_size,
    )
    return svc.get_filtered(filters, current_user.id)
...
def get_calendar_events(
    ...
    return svc.get_for_calendar(date_from, date_to, current_user.id)
...
def get_activity(
    ...
    return svc.get_by_id(activity_id, current_user.id)
...
def update_activity(
    ...
    return svc.update(activity_id, payload, current_user.id)
...
def delete_activity(
    ...
    svc.delete(activity_id, current_user.id)
...
def complete_activity(
    ...
    return svc.mark_completed(activity_id, current_user.id)
